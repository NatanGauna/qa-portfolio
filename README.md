...
---
## 📊 Relatório Executivo Gerado pela Automação

Ao final de cada execução, a suíte gera automaticamente um relatório executivo consolidando:

- Status da execução
- Quantidade de cenários executados
- Falhas bloqueantes
- Backlog técnico
- Decisão da release
